...
class ListDriver
    ...
    def delete driver
        self.driver_list.delete(driver)
    end
    ...
    def each
        @driver_list.each {|driver_list| yield driver_list}
    end
